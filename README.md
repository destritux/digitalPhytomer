...
- [simulate_emergent_cognition.py](file:///home/destritux/Projetos/Digital%20Phytomer/simulate_emergent_cognition.py): Main orchestrator running swarms, baselines, lesion studies, and statistical validation.
- [lsystem_regenerator.py](file:///home/destritux/Projetos/Digital%20Phytomer/lsystem_regenerator.py): Standalone L-System generative grammar interpreter.
- [micro_agent.py](file:///home/destritux/Projetos/Digital%20Phytomer/micro_agent.py): Definition of cognitive MicroAgents (resource management, somatic vector query, and local delegation logic).
- [test_lsystem_regenerator.py](file:///home/destritux/Projetos/Digital%20Phytomer/test_lsystem_regenerator.py): Unit test suite for verifying the grammar states, timers, and topological rules.
- [run_all.py](file:///home/destritux/Projetos/Digital%20Phytomer/run_all.py): Orchestrates the entire pipeline (runs unit tests -> runs simulation -> compiles report).
- [generate_report.py](file:///home/destritux/Projetos/Digital%20Phytomer/generate_report.py) & [generate_graphics_report.py](file:///home/destritux/Projetos/Digital%20Phytomer/generate_graphics_report.py): Generates professional academic reports from CSV logs.
...
To run the L-System unit tests, execute the full simulation across all 30 seeds, and generate the academic reports, run:
```bash
python run_all.py
```
...
```bash
python -m unittest test_lsystem_regenerator.py
```
